...
A parte que eu ainda estudaria com mais profundidade é a arquitetura interna do Prisma 7, já que meu entendimento dela veio principalmente de resolver os erros que apareceram na prática. Também estudaria mais como aplicar testes automatizados - por ser um diferencial na avaliação, com a ajuda da IA implementei ao fim do projeto um teste automatizado cobrindo a regra de feedback crítico e alguns casos relacionados, para aprender e entender o funcionamento. Ainda gostaria de aprofundar meu conhecimento sobre o assunto.